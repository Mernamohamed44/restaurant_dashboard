...
class DrinksCategories extends StatefulWidget {
  const DrinksCategories({super.key});

  @override
  State<DrinksCategories> createState() => _DrinksCategoriesState();
}

class _DrinksCategoriesState extends State<DrinksCategories> {
